...
require([
	...
	var packs = [
		...
		['Plugins', [
			...
			['Pagination', 'test_grid_pagination', 'pagination.jpg', 'Visually paging the rows, let the user control paging details. This is a useful alternative to virtual scrolling.'],
			...
			['Drag & Drop', 'test_grid_dnd', 'dnd.jpg', 'Drag and drop grid rows, columns and even cells.'],
